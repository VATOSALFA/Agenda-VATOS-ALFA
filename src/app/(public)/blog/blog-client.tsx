            ...
            <header className="sticky top-0 z-50 w-full border-b border-slate-800 bg-slate-950/95 backdrop-blur supports-[backdrop-filter]:bg-slate-950/60">
                <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-6">
                    <div className="flex items-center gap-2 font-bold text-xl tracking-tight">
                        <Link href="/" prefetch={false} className="flex items-center gap-2 text-white hover:text-blue-400 transition-colors">
                    ...
                    <div className="flex gap-4 items-center">
                        <Link href="/" prefetch={false} className="text-sm font-medium hover:text-white transition-colors text-slate-300">
                            Inicio
                        </Link>
            ...
            <footer className="py-12 border-t border-slate-800 bg-slate-900 text-center text-sm text-slate-400">
                <div className="container mx-auto px-4 flex flex-col items-center gap-4">
                    ...
                    <div className="flex flex-wrap justify-center gap-6 text-xs font-medium text-slate-400">
                        <Link href="/" prefetch={false} className="hover:underline hover:text-blue-400 transition-colors">
                            Inicio
                        </Link>
                        <Link href="/privacidad" prefetch={false} className="hover:underline hover:text-blue-400 transition-colors">
                            Aviso de Privacidad
                        </Link>
                        <Link href="/terminos" prefetch={false} className="hover:underline hover:text-blue-400 transition-colors">
