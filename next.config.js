...
const nextConfig = {
  ...
  env: {
    ...
    NEXT_PUBLIC_TWILIO_ACCOUNT_SID: process.env.TWILIO_ACCOUNT_SID,
    NEXT_PUBLIC_TWILIO_AUTH_TOKEN: process.env.TWILIO_AUTH_TOKEN,
    NEXT_PUBLIC_TWILIO_PHONE_NUMBER: process.env.TWILIO_PHONE_NUMBER,
  }
};
